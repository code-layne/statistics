%! Skills Focus: Selecting an Appropriate Inference Procedure for Categorical Data — Unit 8, Lesson 8.7 — Exit Ticket
...
\item A researcher collects one random sample of 300 college students and records two
      ...
      \begin{enumerate}[label=\alph*.]
        ...
        \item $H_0$ (write in context): \writeline
      \end{enumerate}
...
\item A public health researcher randomly samples 200 adults from a rural county and 200 adults
      ...
      \begin{enumerate}[label=\alph*.]
        \item Procedure: \blank{9cm}
        \item Why is a confidence interval (not a test) appropriate here? \writeline
      \end{enumerate}
