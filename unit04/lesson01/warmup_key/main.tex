%! AP Statistics — Unit 4, Lesson 4.1 — Warm-Up KEY
...
\pageheader{Unit 4, Lesson 4.1}{Warm-Up --- KEY}
\namedateperiod
...
\begin{enumerate}
    ...
    \begin{enumerate}[label=(\alph*), itemsep=4pt]
        \item \ans{Negative direction, roughly linear form, moderate-to-strong strength.}
        \item \ans{No. This is an observational study; association does not imply causation. A confounding variable (e.g., time available for reading) could explain both variables.}
    \end{enumerate}
...
\begin{teachernote}
Answers will vary. Accept any reasonable personal example. Look for students who connect the streak/pattern to a \emph{claim} (``the team is really good right now'' vs.\ ``it could just be luck'').
\end{teachernote}
