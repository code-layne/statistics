...
\begin{enumerate}[leftmargin=1.5em, itemsep=10pt]
  ...
  \begin{teachernote}
  Correct bar chart: 4 separated bars. X-axis: News, Sports, Reality, Other
  (any order acceptable). Y-axis: ``Relative Frequency'' (or ``Proportion''),
  scale 0 to at least 0.40 (or 0 to 40\%). Bars: News 0.40 (tallest), Sports
  0.25, Reality 0.20, Other 0.15. Bars do NOT touch. Title required.

  Scoring (suggested 4-point rubric):
  1 pt --- title present; 1 pt --- both axes labeled with scale from 0;
  1 pt --- correct bar heights; 1 pt --- bars separated (gaps present).
  \end{teachernote}
