...
\newcommand{\writelines}[1]{%
  \foreach \i in {1,...,#1}{\writeline\\}}
\newcommand{\termblank}[1]{%
  \noindent\textbf{\textcolor{navy}{#1:}}\quad\blank{6.5cm}\\[1pt]
  \writeline\\[2pt]}
...
% ── Page header ──────────────────────────────────────────────────────────────
    ...
    \colorbox{navy}{%
        \parbox{\dimexpr\linewidth}{%
            ...
            {\color{skymid}\small\textbf{Guided Notes}}
            \vspace{6pt}
        }%
    }
    \vspace{1.5em}
