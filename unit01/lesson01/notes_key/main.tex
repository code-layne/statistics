...
\textcolor{keyred}{\textbf{the science of collecting, analyzing, and drawing conclusions from data}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Individual:}}\quad
\textcolor{keyred}{\textbf{a single person, object, or event in a dataset}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Population:}}\quad
\textcolor{keyred}{\textbf{the entire group of individuals of interest}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Sample:}}\quad
\textcolor{keyred}{\textbf{a subset of the population from which data are collected}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Census:}}\quad
\textcolor{keyred}{\textbf{data collected from EVERY individual in the population}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Variability / Variation:}}\\
\textcolor{keyred}{\textbf{natural differences in values across individuals — the reason statistics exists}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Data:}}\quad
\textcolor{keyred}{\textbf{recorded values for individuals; can be categorical or quantitative}}\\[4pt]

\noindent\textbf{\textcolor{navy}{Anecdotal evidence:}}\\
\textcolor{keyred}{\textbf{data from a few unrepresentative cases; not reliable for drawing conclusions}}\\[4pt]
